...
class SegmentEditorDragEffect(SegmentEditorAbstractEffect):
  ...
  def __init__(self, scriptedEffect):
    ...
    scriptedEffect.title = _("Drag Segment")
    self.previewSteps = 4
  ...
  def helpText(self):
    return _("""<html>Drag the selected segment:<br>
    <ul>
      <li>Cursor: open hand</li>
      <li>Left-click inside segment: hand becomes closed and segment can be dragged</li>
      <li>Release mouse: updates segment contour position</li>
    </ul></html>""")
